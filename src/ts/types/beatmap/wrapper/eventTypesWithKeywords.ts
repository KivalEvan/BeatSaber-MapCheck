...
import { IWrapEventTypesForKeywords, IWrapEventTypesForKeywordsAttribute } from './eventTypesForKeywords';

export interface IWrapEventTypesWithKeywordsAttribute<T extends Record<keyof T, unknown> = Record<string, unknown>> {
