 ...
 * ```
 */
export interface IChromaEventLight extends ICustomData {
    _color?: ColorArray;
 ...
 * ```
 */
export interface IChromaEventLaser extends ICustomData {
    _lockPosition?: boolean;
    _speed?: number;
 ...
 * ```
 */
export interface IChromaEventRotation extends ICustomData {
    _nameFilter?: string;
    _reset?: boolean;
    _rotation?: number;
    _step?: number;
 ...
 * ```
 */
export interface IChromaEventZoom extends ICustomData {
    _step?: number;
    _speed?: number;
}
