...
import {
    ...
    NoteContainerBomb,
    NoteContainerNote,
} from '../../types/beatmap/v3/container';
import {
    ParityState,
    ParityStatus,
    ParitySwitch,
} from '../../types/mapcheck/analyzers/parity';
...
export default class Parity {
    ...
    public check(
        ...
        if (
            parityRotation <
                Parity.CONSTRAINT_ROTATION[noteType][0] + this.warningThreshold ||
            parityRotation >
    ...
    public next(noteContext: NoteContainer[], bombContext: NoteContainerBomb[]): void {
        ...
        if (expectedDirection !== 8) {
            this.rotation =
                noteParityRotation[this.color][this.state][expectedDirection];
        }
    }
